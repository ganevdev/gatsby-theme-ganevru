...
Это единственный пакет проекта который выложен в опенсорс. Вот репо: [actor-liquipedia-semantic-search](https://github.com/Ganevru/actor-liquipedia-semantic-search). Скрапер просто скачивает JSON файлы с информацией об игроках (именно скачивает, а не формирует. Семантический поиск ликвидпедии позволяет просто скачать JSON файлы) и проводит их обработку и фильтрацию.
...
Эта информация нужна не только для отображения на сайте, но и для того чтобы отлавливать какие либо аномалии в статистике.
