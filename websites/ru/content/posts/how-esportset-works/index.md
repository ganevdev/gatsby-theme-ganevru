...
- [Общая архитектура проекта](#Общая-архитектура-проекта)
...
- [EsportSet Data - обработка полученных данных](#esportset-data---обработка-полученных-данных)
  - [Очистка информации и объединение с Гугл Таблицей](#Очистка-информации-и-объединение-с-Гугл-Таблицей)
  - [Статистика по игрокам](#Статистика-по-игрокам)
  - [Статистика по девайсам](#Статистика-по-девайсам)
...
- [Генерация сайтов при помощи Gatsbyjs](#Генерация-сайтов-при-помощи-gatsbyjs)
  ...
  - [Два сайт, один код](#Два-сайт-один-код)
...
Как видите на самом деле это _четыре_ таблицы, которые находятся внутри `<div class="table-responsive">`, при чем самая верхняя таблица нужна только для того что бы быть чем-то вроде "заголовка".
